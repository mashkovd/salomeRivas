...
season_2023_df = week_df[week_df["season"] == 2023]

# Calculate the total touchdowns, receptions, and yardage for each player
season_2023_df = season_2023_df.copy()
season_2023_df.loc[:, "total_touchdowns"] = (
    season_2023_df["reception_td"] + season_2023_df["run_td"]
)
season_2023_df.loc[:, "total_yards"] = (
    season_2023_df["receiving_yards"] + season_2023_df["rushing_yards"]
)


# Group by player and calculate the averages
average_stats_2023 = (
    season_2023_df.groupby("player_name")
    .agg(
        {
...
pinkyl_colors = sample_colorscale(
    "Pinkyl", [i / (num_players - 1) for i in range(num_players)]
)

touchdown_colors = sample_colorscale(
    "Pinkyl", [i / (num_touchdown_players - 1) for i in range(num_touchdown_players)]
)
reception_colors = sample_colorscale(
    "Pinkyl", [i / (num_reception_players - 1) for i in range(num_reception_players)]
)
yardage_colors = sample_colorscale(
    "Pinkyl", [i / (num_yardage_players - 1) for i in range(num_yardage_players)]
)
...
normalized_df = (
    ...
    .apply(normalize_seasons, include_groups=False)
...
navbar = dbc.NavbarSimple(
    children=[
        ...
        dbc.NavItem(
            dcc.Link("Player Analysis", href="/player-analysis", className="nav-link")
        ),
            ...
            [
                ...
                html.Ul(
                    [
                        ...
                        html.Li(
                            "Identify top players based on key metrics like touchdowns, receptions, and yardage."
                        ),
                        html.Li(
                            "Compare players' career and weekly performance to make informed decisions."
                        ),
                        html.Li(
                            "Explore interactive charts to uncover hidden patterns and insights."
                        ),
                    ]
                ),
                ...
                html.Ul(
                    [
                        html.Li(
                            "Seasonal Analysis: Explore the top performers for each season (2012-2023) in categories like touchdowns, receptions, and total yardage."
                        ),
                        html.Li(
                            "Weekly Performance: Dive into detailed weekly stats for the 2023 season, including averages and top 3 players for touchdowns, receptions, and yardage."
                        ),
                        html.Li(
                            "Career Comparisons: Compare career stats of standout players, including their average touchdowns, receptions, and games per season."
                        ),
                        html.Li(
                            "Interactive Graphs: Intuitive and interactive visualizations for seamless exploration of player data."
                        ),
                        html.Li(
                            "Consistent Performers: Identify players who consistently rank in the top 10 across multiple seasons."
                        ),
                    ]
                ),
                ...
                html.Ul(
                    [
                        html.Li(
                            "Fans: Discover how your favorite players stack up against the competition."
                        ),
                        html.Li(
                            "Coaches and Analysts: Use insights to strategize and refine gameplay."
                        ),
                        html.Li(
                            "Sponsors: Find the best players to endorse by evaluating their consistent performance and marketability."
                        ),
                        html.Li(
                            "Fantasy Football Enthusiasts: Make informed picks and trades for your fantasy team."
                        ),
                    ]
                ),
...
player_layout = html.Div(
    [
            ...
            [
                ...
                dcc.RangeSlider(
                    ...
                    marks={
                        year: str(year)
                        for year in range(
                            year_df["season"].min(), year_df["season"].max() + 1
                        )
                    },
        ...
        html.H1(
            "Player Comparison with Dynamic Season Selection",
        ...
        html.H1(
            "Player Comparison with Baseline",
            style={"textAlign": "center", "marginBottom": "20px"},
        ),
    ...
    [
        ...
        html.Div(
            [
                ...
                html.H3(
                    "2020-2023 Yardage, Touchdown, and Reception Analysis",
        ...
        html.Div(
            [
                html.H1(
                    "2023 Weekly Player Analysis",
                    style={"textAlign": "center", "marginBottom": "30px"},
                ),
                html.H3(
                    "Average Weekly Performance Metrics", style={"textAlign": "center"}
                ),
                html.P(
                ...
                html.Div([dcc.Graph(figure=top_3_fig)], style={"padding": "20px"}),
                html.P(
                ...
                html.Div(
                    [
                        html.H3(
                            "Players Excelling in Multiple Metrics",
                            style={"textAlign": "center"},
                        ),
                        html.P(
                            "These players have appeared in multiple top categories over the last 4 seasons",
                            style={"textAlign": "center"},
                        ),
                        html.Ul(
                            [
                ...
                html.Div(
                    [
                        ...
                        html.H3(
                            "Justin Jefferson vs. Davante Adams vs. Tyreek Hill",
                            style={"textAlign": "center"},
                        ),
                        html.Div(
                            [
                        ...
                        # ]),
                        html.H1(
                            "Machine Learning Results: Weighted Random Forest Scores",
                            style={"textAlign": "center", "marginTop": "40px"},
                        ),
                        html.Div(
                            [
                        ...
                        html.Div(
                            [
                                html.H3(
                                    "Player Sponsorship Recommendation",
...
def update_comparison_graph(season_range, player1, player2, player3):
    ...
    options = [
        ...
        for player in sorted(normalized_df["player_name"].unique())
    ]
